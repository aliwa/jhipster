...
public class InitialSetupMigration {
    ...
    private void addUsers(Authority userAuthority, Authority adminAuthority) {
        Userfalse user = createUser(userAuthority);
        template.save(user);
        Userfalse admin = createAdmin(adminAuthority, userAuthority);
        template.save(admin);
    }

    private Userfalse createUser(Authority userAuthority) {
        Userfalse userUser = new Userfalse();
    ...
    private Userfalse createAdmin(Authority adminAuthority, Authority userAuthority) {
        Userfalse adminUser = new Userfalse();
