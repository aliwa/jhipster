...
import com.aliwa.generator.service.mapper.UserMapper;
...
class UserResourceIT {
     ...
     */
    public static Userfalse createEntity() {
     ...
     */
    public static Userfalse initTestUser(UserRepository userRepository) {
        userRepository.deleteAll();
        Userfalse user = createEntity();
        return user;
    }
    ...
    void createUser() throws Exception {
        ...
        assertPersistedUsers(users -> {
            ...
            Userfalse testUser = users.get(users.size() - 1);
    ...
    void updateUser() throws Exception {
        ...
        // Update the user
        Userfalse updatedUser = userRepository.findById(user.getId()).orElseThrow();
        ...
        assertPersistedUsers(users -> {
            ...
            Userfalse testUser = users.stream().filter(usr -> usr.getId().equals(updatedUser.getId())).findFirst().orElseThrow();
