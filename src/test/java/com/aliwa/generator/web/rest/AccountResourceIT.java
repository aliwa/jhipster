package com.aliwa.generator.web.rest;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.aliwa.generator.IntegrationTest;
import com.aliwa.generator.config.Constants;
import com.aliwa.generator.domain.Userfalse;
import com.aliwa.generator.repository.AuthorityRepository;
import com.aliwa.generator.repository.UserRepository;
import com.aliwa.generator.security.AuthoritiesConstants;
import com.aliwa.generator.service.UserService;
import com.aliwa.generator.service.dto.AdminUserDTO;
import com.aliwa.generator.service.dto.PasswordChangeDTO;
import com.aliwa.generator.web.rest.vm.KeyAndPasswordVM;
import com.aliwa.generator.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        Optional<Userfalse> user = userRepository.findOneByEmailIgnoreCase("funky@example.com");
    ...
    void testRegisterInvalidEmail() throws Exception {
        ...
        Optional<Userfalse> user = userRepository.findOneByLogin("bob");
        assertThat(user).isEmpty();
    }
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        Optional<Userfalse> testUser = userRepository.findOneByEmailIgnoreCase("alice2@example.com");
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        Optional<Userfalse> testUser1 = userRepository.findOneByLogin("test-register-duplicate-email");
        ...
        Optional<Userfalse> testUser2 = userRepository.findOneByLogin("test-register-duplicate-email");
        assertThat(testUser2).isEmpty();

        Optional<Userfalse> testUser3 = userRepository.findOneByLogin("test-register-duplicate-email-2");
        ...
        Optional<Userfalse> testUser4 = userRepository.findOneByLogin("test-register-duplicate-email-3");
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        Optional<Userfalse> userDup = userRepository.findOneByLogin("badguy");
    ...
    void testSaveAccount() throws Exception {
        ...
        Userfalse updatedUser = userRepository.findOneByLogin(user.getLogin()).orElse(null);
    ...
    void testSaveExistingEmail() throws Exception {
        ...
        Userfalse anotherUser = new Userfalse();
        ...
        Userfalse updatedUser = userRepository.findOneByLogin("save-existing-email").orElse(null);
    ...
    void testSaveExistingEmailAndLogin() throws Exception {
        ...
        Userfalse updatedUser = userRepository.findOneByLogin("save-existing-email-and-login").orElse(null);
    ...
    void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        Userfalse updatedUser = userRepository.findOneByLogin("change-password-wrong-existing-password").orElse(null);
    ...
    void testChangePassword() throws Exception {
        ...
        Userfalse updatedUser = userRepository.findOneByLogin("change-password").orElse(null);
    ...
    void testChangePasswordTooSmall() throws Exception {
        ...
        Userfalse updatedUser = userRepository.findOneByLogin("change-password-too-small").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordTooLong() throws Exception {
        ...
        Userfalse updatedUser = userRepository.findOneByLogin("change-password-too-long").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordEmpty() throws Exception {
        ...
        Userfalse updatedUser = userRepository.findOneByLogin("change-password-empty").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
